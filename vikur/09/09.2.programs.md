---
title: Fyrirlestur 9.2 – JavaScript forrit
---

# Fyrirlestur 9.2 – JavaScript forrit
...
* [variables dæmi](daemi/2.programs/01.variables.js)
...
* [input dæmi](daemi/2.programs/02.input.js)
...
* Staðlaðir hlutir eins og [`Math`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Math), [`Date`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date) [og fleiri](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects)
...
* Í grunninn byggt á millisekúndum síðan `1970-01-01 00:00:00 UTC` (Unix time)
...
* [math dæmi](daemi/2.programs/03.math.js)
* [date dæmi](daemi/2.programs/04.date.js)
...
* [if dæmi](daemi/2.programs/05.if.js)
...
* [loops dæmi](daemi/2.programs/06.loops.js)
